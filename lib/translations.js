export const translations = {
  en: {
    demoNotice: {
      ...
      text: "This site showcases my skills as a developer for friends, contacts, and job applications. I'm not yet operating as a registered business — self-employment starts November 1, 2027 — so no commercial services are being offered here yet. Feel free to reach out anyway, I'd love to chat.",
      button: "Got it",
    },
    nav: {
      home: "home",
    ...
    contactFab: {
      ...
      whatsapp: "WhatsApp",
      form: "Contact form",
      callConfirmTitle: "Give me a call?",
      callConfirmDesc: "You're about to call (+49) 162 631 0090. Ready to dial?",
      callConfirmAction: "Call now",
      whatsappConfirmTitle: "Open WhatsApp?",
      whatsappConfirmDesc: "You'll be redirected to WhatsApp to chat with me directly.",
      whatsappConfirmAction: "Open WhatsApp",
      cancel: "Cancel",
    },
    exploreMore: {
      hint: "Wanna see more?",
      bridgeTitle: "Ready for the good part?",
      bridgeHint: "Keep scrolling",
      title: "The only way is up!",
      points: [
        "I go all in on your vision, however specific it is",
        "You're involved in every step, not just the final reveal",
        "Every project gets my absolute highest standards",
        "One person, zero overhead — prices that are hard to beat",
      ],
      servicesButton: "Explore my services",
      whatsappText: "Let's just chat on WhatsApp — casual, no strings attached.",
      whatsappButton: "Chat on WhatsApp",
      dreamButton: "Let's build your dream!",
      noteLabel: "Note:",
      note: "I deliver in 2–8 weeks, keep you closely involved every step of the way, and can offer exceptional pricing for the right project.",
    },
    home: {
      ...
      ctaBanner: {
        ...
        subtitle:
          "Let's talk it through — straightforward, tailored, and personal. First conversation is on me. Reaching out is 100% free and risk-free — no obligation, just a relaxed chat about what an implementation could look like.",
        button: "Start your project",
      },
    },
    stats: [
      { num: 6, suffix: "+", text: "Years of experience" },
      { num: 13, suffix: "", text: "Projects completed" },
      { num: 154, suffix: "", text: "Code commits" },
    ],
    services: [
      {
        num: "01",
    ...
    work: {
      ...
      projects: [
        {
          num: "01",
          category: "Presence Site",
          title: "vd-handwerk2.de",
          description:
            "A clean, fast presence site for a handwerk business — built to make a strong first impression and turn visitors into inquiries.",
          stack: [{ name: "Next.js" }, { name: "Tailwind.css" }],
          live: "https://vd-handwerk2.de",
          github: "",
        },
        {
          num: "02",
          ...
          description:
            "A portfolio design exploring bold typography and a distinctive visual identity — currently live as a shared Claude artifact.",
          stack: [{ name: "Next.js" }, { name: "Tailwind.css" }, { name: "Framer Motion" }],
          live: "https://claude.ai/public/artifacts/560a8ad5-f951-498d-9f86-9d0170dcf865",
          github: "",
        },
        {
          num: "03",
          ...
          description:
            "A ready-to-use website template for gyms and fitness studios — built for quick customization and a strong, energetic first impression.",
          stack: [{ name: "Next.js" }, { name: "Tailwind.css" }],
          live: "",
          github: "",
        },
        {
          ...
          title: "Toolshub.io",
          description:
            "A collection of small, focused web tools bundled into one fast, ad-light platform — built for everyday utility.",
          stack: [{ name: "Next.js" }, { name: "Node.js" }, { name: "Tailwind.css" }],
          live: "https://toolshub.io",
          github: "",
        },
        {
          num: "05",
          ...
          title: "Coming Soon!",
          description:
            "A new project is currently in the works — check back soon to see what's next.",
          stack: [],
          live: "",
          github: "",
        },
    ...
    contact: {
      ...
      infoEmail: "Email",
      infoAddress: "Address",
      infoAddressValue: "Bergneustadt, Germany",
      qrCaption: "Scan to save my contact",
      privacyNotice: "By submitting this form, you agree to the processing of your data as described in our",
      privacyLinkLabel: "Privacy Policy",
      blockedTitle: "Form Currently Inactive",
      blockedText: "This site exists solely to showcase my skills for job applications — not to offer freelance or self-employed services. The contact form is disabled for now. If you'd still like to reach out, WhatsApp or email works great.",
      blockedClose: "Got it",
    },
    footer: {
    ...
    cookieConsent: {
      text: "We use essential cookies to run this site, and optionally analytics cookies to understand how it's used. Read more in our",
      ...
      analyticsDesc: "Helps us understand how visitors use the site. Not currently in use.",
      save: "Save Selection",
    },
    serviceDetails: {
      ...
      uiux: {
        ...
        showcaseHeading: "See It In Motion",
        showcaseSubtitle: "No video, no mockup — these are live, running right now. Move your cursor over them.",
        showcase: [
          { title: "Magnetic Hover", desc: "Elements that gently follow your cursor" },
          { title: "3D Cube", desc: "A real cube, rotating in true 3D space" },
          { title: "Liquid Morph", desc: "Shapes that breathe and flow" },
          { title: "Elastic Spring", desc: "Physics-based motion that feels alive" },
          { title: "Loading Ring", desc: "A progress ring animating to a satisfying finish" },
          { title: "Particle Burst", desc: "A tiny explosion of physics-driven particles" },
          { title: "Flip Reveal", desc: "A card that flips to reveal what's behind it" },
          { title: "Ripple Wave", desc: "Concentric ripples radiating outward" },
          { title: "Glow Pulse", desc: "A soft glow that breathes outward and fades" },
          { title: "Shimmer", desc: "A light sweep across a loading bar" },
          { title: "Drag & Snap", desc: "Drag it anywhere, it springs back to center" },
          { title: "Confetti Pop", desc: "A tiny burst of colorful confetti" },
          { title: "Toggle Switch", desc: "A smooth on/off thumb slide" },
          { title: "Progress Fill", desc: "A bar filling with a satisfying ease" },
          { title: "3D Tilt", desc: "A card tilting with your cursor in real 3D" },
          { title: "Blink Cursor", desc: "A tiny typewriter with a blinking caret" },
          { title: "Like Burst", desc: "A heart that fills and bursts with a tap" },
          { title: "Star Rating", desc: "Hover to preview, click to lock a rating" },
          { title: "Skeleton Load", desc: "A shimmering placeholder that resolves into content" },
          { title: "Tab Underline", desc: "An indicator that glides beneath the active tab" },
          { title: "Range Slider", desc: "A draggable thumb with a live value readout" },
          { title: "Notification Badge", desc: "A counter that pops with every new alert" },
          { title: "Copy Feedback", desc: "An icon that confirms the copy with a checkmark" },
          { title: "Dots Loader", desc: "Three dots bouncing in an endless loop" },
        ],
      },
      logo: {
        title: "Logo Design",
  ...
  de: {
    demoNotice: {
      title: "Privates Portfolio-Projekt",
      text: "Diese Seite zeigt Freunden, Kontakten und potenziellen Arbeitgebern meine Skills als Entwickler. Ich bin noch nicht als Gewerbe bzw. selbstständig angemeldet — das ist erst zum 1. November 2027 geplant — daher werden hier aktuell keine gewerblichen Dienstleistungen angeboten. Meld dich trotzdem gerne, ich freue mich auf jedes Gespräch.",
      button: "Verstanden",
    },
    nav: {
      home: "Startseite",
    ...
    contactFab: {
      ...
      callConfirmTitle: "Anrufen?",
      callConfirmDesc: "Du rufst gleich (+49) 162 631 0090 an. Bereit?",
      callConfirmAction: "Jetzt anrufen",
      whatsappConfirmTitle: "WhatsApp öffnen?",
      whatsappConfirmDesc: "Du wirst zu WhatsApp weitergeleitet, um direkt mit mir zu chatten.",
      whatsappConfirmAction: "WhatsApp öffnen",
      cancel: "Abbrechen",
    },
    exploreMore: {
      hint: "Noch mehr sehen?",
      bridgeTitle: "Bereit für den guten Teil?",
      bridgeHint: "Weiter scrollen",
      title: "The only way is up!",
      points: [
        "Ich gehe auf jeden Kundenwunsch ein – so individuell wie nötig",
        "Du wirst maximal in die Umsetzung eingebunden, nicht nur am Ende informiert",
        "Jedes Projekt bekommt meinen höchsten Anspruch",
        "Eine Person, kein Overhead – unschlagbare Preise",
      ],
      servicesButton: "Meine Leistungen entdecken",
      whatsappText: "Lass uns einfach auf WhatsApp quatschen – ganz unverbindlich und locker.",
      whatsappButton: "Auf WhatsApp chatten",
      dreamButton: "Lass uns deinen Traum verwirklichen!",
      noteLabel: "Hinweis:",
      note: "Ich setze dein Projekt in 2–8 Wochen um, binde dich dabei maximal ein und kann bei passenden Projekten absolute Sonderkonditionen anbieten.",
    },
    home: {
      ...
      talkFree: "Jetzt kostenlos quatschen!",
      terminal: {
      ...
      ctaBanner: {
        ...
        subtitle:
          "Lass uns unkompliziert, individuell und persönlich darüber sprechen. Das erste Gespräch geht auf mich. Eine Kontaktanfrage ist 100% kostenlos und risikofrei — ganz unverbindlich, wir schauen einfach, wie eine Umsetzung aussehen könnte.",
        button: "Projekt starten",
      },
    },
    stats: [
      { num: 6, suffix: "+", text: "Jahre Erfahrung" },
      { num: 13, suffix: "", text: "Projekte abgeschlossen" },
      { num: 154, suffix: "", text: "Code Commits" },
    ],
    services: [
      {
    ...
    work: {
      videoComingSoon: "Video kommt bald",
      projects: [
        {
          num: "01",
          category: "Präsenzseite",
          title: "vd-handwerk2.de",
          description:
            "Eine schlanke, schnelle Präsenzseite für einen Handwerksbetrieb – gebaut für einen starken ersten Eindruck und mehr Anfragen.",
          stack: [{ name: "Next.js" }, { name: "Tailwind.css" }],
          live: "https://vd-handwerk2.de",
          github: "",
        },
        {
          ...
          title: "Portfolio-Website",
          description:
            "Ein Portfolio-Design mit auffälliger Typografie und eigenständiger visueller Identität – aktuell live als geteiltes Claude-Artifact.",
          stack: [{ name: "Next.js" }, { name: "Tailwind.css" }, { name: "Framer Motion" }],
          live: "https://claude.ai/public/artifacts/560a8ad5-f951-498d-9f86-9d0170dcf865",
          github: "",
        },
        {
          num: "03",
          category: "Template",
          title: "Fitnessstudio-Template",
          description:
            "Ein einsatzbereites Website-Template für Fitnessstudios und Gyms – schnell anpassbar, mit kräftigem, energiegeladenem ersten Eindruck.",
          stack: [{ name: "Next.js" }, { name: "Tailwind.css" }],
          live: "",
          github: "",
        },
        {
          ...
          title: "Toolshub.io",
          description:
            "Eine Sammlung kleiner, fokussierter Web-Tools auf einer schnellen, werbearmen Plattform gebündelt – für den täglichen Gebrauch.",
          stack: [{ name: "Next.js" }, { name: "Node.js" }, { name: "Tailwind.css" }],
          live: "https://toolshub.io",
          github: "",
        },
        {
          ...
          title: "Coming Soon!",
          description:
            "Ein neues Projekt ist gerade in Arbeit – schau bald wieder vorbei.",
          stack: [],
          live: "",
          github: "",
        },
    ...
    contact: {
      ...
      infoEmail: "E-Mail",
      infoAddress: "Adresse",
      infoAddressValue: "Bergneustadt, Deutschland",
      qrCaption: "Scannen, um meinen Kontakt zu speichern",
      privacyNotice: "Mit dem Absenden dieses Formulars stimmst du der Verarbeitung deiner Daten gemäß unserer",
      privacyLinkLabel: "Datenschutzerklärung",
      blockedTitle: "Formular aktuell inaktiv",
      blockedText: "Diese Seite dient ausschließlich der Jobsuche und zeigt meine Skills für Bewerbungen — nicht dem Angebot selbstständiger Dienstleistungen oder Freelancing. Das Kontaktformular ist daher vorerst deaktiviert. Wenn du mich trotzdem erreichen möchtest, klappt das prima über WhatsApp oder E-Mail.",
      blockedClose: "Verstanden",
    },
    footer: {
    ...
    cookieConsent: {
      text: "Wir verwenden technisch notwendige Cookies für den Betrieb dieser Website sowie optional Analyse-Cookies, um zu verstehen, wie sie genutzt wird. Mehr dazu in unserer",
      ...
      analyticsDesc: "Hilft uns zu verstehen, wie Besucher die Website nutzen. Aktuell nicht im Einsatz.",
    ...
    serviceDetails: {
      ...
      uiux: {
        ...
        tools: ["Figma", "Adobe XD", "Sketch", "Wireframing", "Prototyping", "Nutzertests"],
        ...
        features: [
          ...
          { title: "Intuitive Oberflächen", description: "Erlebnisse, die sich natürlich anfühlen und keine Lernkurve haben." },
        ...
        showcaseHeading: "Live erleben",
        showcaseSubtitle: "Kein Video, kein Mockup – das läuft gerade live. Bewege einfach den Mauszeiger darüber.",
        showcase: [
          { title: "Magnetischer Hover", desc: "Elemente, die deinem Cursor sanft folgen" },
          { title: "3D-Würfel", desc: "Ein echter Würfel, der sich im 3D-Raum dreht" },
          { title: "Flüssiger Morph", desc: "Formen, die atmen und fließen" },
          { title: "Elastische Feder", desc: "Physikbasierte Bewegung, die lebendig wirkt" },
          { title: "Lade-Ring", desc: "Ein Fortschrittsring mit befriedigendem Abschluss" },
          { title: "Partikel-Explosion", desc: "Eine kleine Explosion physikbasierter Partikel" },
          { title: "Flip-Reveal", desc: "Eine Karte, die sich dreht und die Rückseite zeigt" },
          { title: "Ripple-Welle", desc: "Konzentrische Wellen, die nach außen laufen" },
          { title: "Glow-Puls", desc: "Ein sanftes Leuchten, das nach außen atmet und verblasst" },
          { title: "Shimmer", desc: "Ein Lichtstreif, der über einen Ladebalken zieht" },
          { title: "Ziehen & Einrasten", desc: "Zieh ihn irgendwohin, er springt zur Mitte zurück" },
          { title: "Konfetti-Pop", desc: "Eine kleine Explosion aus buntem Konfetti" },
          { title: "Toggle-Switch", desc: "Ein weicher An/Aus-Schieberegler" },
          { title: "Fortschrittsbalken", desc: "Ein Balken, der sich befriedigend füllt" },
          { title: "3D-Neigung", desc: "Eine Karte, die sich mit deinem Cursor in echtem 3D neigt" },
          { title: "Blink-Cursor", desc: "Eine kleine Schreibmaschine mit blinkendem Cursor" },
          { title: "Like-Puls", desc: "Ein Herz, das sich beim Tippen füllt und aufblitzt" },
          { title: "Sterne-Bewertung", desc: "Hover zeigt die Vorschau, Klick fixiert die Bewertung" },
          { title: "Skeleton-Loader", desc: "Ein schimmernder Platzhalter, der zu Inhalt wird" },
          { title: "Tab-Unterstreichung", desc: "Eine Markierung, die unter dem aktiven Tab gleitet" },
          { title: "Schieberegler", desc: "Ein ziehbarer Regler mit Live-Wertanzeige" },
          { title: "Benachrichtigungs-Badge", desc: "Ein Zähler, der bei jeder neuen Meldung aufspringt" },
          { title: "Kopier-Feedback", desc: "Ein Icon, das das Kopieren mit einem Häkchen bestätigt" },
          { title: "Punkte-Loader", desc: "Drei Punkte, die endlos hüpfen" },
        ],
      },
      logo: {
        title: "Logo Design",
      ...
      ai: {
        ...
        bento: [
          ...
          { title: "Konversationsdesign", body: "Intent-Erkennung, Fallback-Strategien und Kontext-Management für zuverlässige KI-Dialoge." },
        ],
  ...
  pl: {
    demoNotice: {
      title: "Prywatny projekt portfolio",
      text: "Ta strona pokazuje moje umiejętności jako dewelopera znajomym, kontaktom i potencjalnym pracodawcom. Nie prowadzę jeszcze zarejestrowanej działalności gospodarczej — planowana na 1 listopada 2027 — więc obecnie nie oferuję tu żadnych usług komercyjnych. Mimo to śmiało się odezwij, chętnie porozmawiam.",
      button: "Rozumiem",
    },
    nav: {
      home: "strona główna",
    ...
    contactFab: {
      ...
      callConfirmTitle: "Zadzwonić?",
      callConfirmDesc: "Za chwilę zadzwonisz pod (+49) 162 631 0090. Gotowy?",
      callConfirmAction: "Zadzwoń teraz",
      whatsappConfirmTitle: "Otworzyć WhatsApp?",
      whatsappConfirmDesc: "Zostaniesz przekierowany do WhatsApp, aby porozmawiać ze mną bezpośrednio.",
      whatsappConfirmAction: "Otwórz WhatsApp",
      cancel: "Anuluj",
    },
    exploreMore: {
      hint: "Chcesz zobaczyć więcej?",
      bridgeTitle: "Gotowy na najlepszą część?",
      bridgeHint: "Przewiń dalej",
      title: "The only way is up!",
      points: [
        "Angażuję się w pełni w Twoją wizję, jakkolwiek szczegółowa by nie była",
        "Jesteś zaangażowany na każdym etapie, nie tylko przy finalnym efekcie",
        "Każdy projekt otrzymuje moje najwyższe standardy",
        "Jedna osoba, zero kosztów ogólnych – ceny trudne do pobicia",
      ],
      servicesButton: "Zobacz moje usługi",
      whatsappText: "Po prostu pogadajmy na WhatsApp – swobodnie i bez zobowiązań.",
      whatsappButton: "Napisz na WhatsApp",
      dreamButton: "Zbudujmy razem Twoje marzenie!",
      noteLabel: "Uwaga:",
      note: "Realizuję projekty w 2–8 tygodni, maksymalnie angażuję Cię w cały proces i mogę zaoferować wyjątkowe warunki cenowe dla odpowiedniego projektu.",
    },
    home: {
      ...
      talkFree: "Porozmawiajmy za darmo!",
      terminal: {
      ...
      ctaBanner: {
        ...
        subtitle:
          "Porozmawiajmy o nim — prosto, indywidualnie i personalnie. Pierwsza rozmowa jest na mnie. Zapytanie jest w 100% bezpłatne i bez ryzyka — bez zobowiązań, po prostu spokojna rozmowa o tym, jak mogłaby wyglądać realizacja.",
        button: "Rozpocznij projekt",
      },
    },
    stats: [
      { num: 6, suffix: "+", text: "Lat doświadczenia" },
      { num: 13, suffix: "", text: "Ukończonych projektów" },
      { num: 154, suffix: "", text: "Commitów w kodzie" },
    ],
    services: [
      {
        num: "01",
      ...
      projects: [
        {
          ...
          title: "vd-handwerk2.de",
          description:
            "Przejrzysta, szybka strona wizerunkowa dla firmy rzemieślniczej – zbudowana, by robić dobre pierwsze wrażenie i generować zapytania.",
          stack: [{ name: "Next.js" }, { name: "Tailwind.css" }],
          live: "https://vd-handwerk2.de",
          github: "",
        },
        {
          ...
          description:
            "Projekt portfolio z odważną typografią i wyrazistą identyfikacją wizualną – obecnie dostępny jako udostępniony artefakt Claude.",
          stack: [{ name: "Next.js" }, { name: "Tailwind.css" }, { name: "Framer Motion" }],
          live: "https://claude.ai/public/artifacts/560a8ad5-f951-498d-9f86-9d0170dcf865",
          github: "",
        },
        {
          num: "03",
          category: "Szablon",
          title: "Szablon siłowni",
          description:
            "Gotowy do użycia szablon strony dla siłowni i klubów fitness – łatwy do szybkiej personalizacji, z mocnym pierwszym wrażeniem.",
          stack: [{ name: "Next.js" }, { name: "Tailwind.css" }],
          live: "",
          github: "",
        },
        {
          ...
          title: "Toolshub.io",
          description:
            "Zbiór małych, skoncentrowanych narzędzi webowych na jednej szybkiej platformie z minimalną ilością reklam – do codziennego użytku.",
          stack: [{ name: "Next.js" }, { name: "Node.js" }, { name: "Tailwind.css" }],
          live: "https://toolshub.io",
          github: "",
        },
        {
          ...
          title: "Coming Soon!",
          description:
            "Nowy projekt jest właśnie w przygotowaniu – zajrzyj tu wkrótce.",
          stack: [],
          live: "",
          github: "",
        },
    ...
    contact: {
      ...
      serviceIndividual: "Indywidualne",
      ...
      infoEmail: "E-mail",
      infoAddress: "Adres",
      infoAddressValue: "Bergneustadt, Niemcy",
      qrCaption: "Zeskanuj, aby zapisać mój kontakt",
      privacyNotice: "Wysyłając ten formularz, wyrażasz zgodę na przetwarzanie Twoich danych zgodnie z naszą",
      privacyLinkLabel: "Polityką prywatności",
      blockedTitle: "Formularz obecnie nieaktywny",
      blockedText: "Ta strona służy wyłącznie do poszukiwania pracy i prezentacji moich umiejętności — nie do oferowania usług freelancingowych czy samozatrudnienia. Formularz kontaktowy jest więc na razie wyłączony. Jeśli mimo to chcesz się ze mną skontaktować, napisz na WhatsApp lub e-mail.",
      blockedClose: "Rozumiem",
    },
    footer: {
    ...
    cookieConsent: {
      text: "Używamy niezbędnych plików cookie do działania tej strony oraz opcjonalnie plików cookie analitycznych, aby zrozumieć jej wykorzystanie. Więcej informacji w naszej",
      linkLabel: "Polityce prywatności",
      acceptAll: "Akceptuj wszystkie",
      rejectAll: "Tylko niezbędne",
      customize: "Dostosuj",
      essentialTitle: "Niezbędne",
      essentialDesc: "Wymagane do działania strony — zawsze aktywne.",
      alwaysOn: "Zawsze aktywne",
      analyticsTitle: "Analityka",
      analyticsDesc: "Pomaga nam zrozumieć, jak odwiedzający korzystają ze strony. Obecnie nieużywane.",
      save: "Zapisz wybór",
    },
    serviceDetails: {
      ...
      uiux: {
        ...
        showcaseHeading: "Zobacz w ruchu",
        showcaseSubtitle: "Żadnego wideo, żadnego mockupu – to dzieje się na żywo. Po prostu najedź kursorem.",
        showcase: [
          { title: "Magnetyczny hover", desc: "Elementy delikatnie podążające za kursorem" },
          { title: "Kostka 3D", desc: "Prawdziwa kostka obracająca się w przestrzeni 3D" },
          { title: "Płynny morfing", desc: "Kształty, które oddychają i płyną" },
          { title: "Elastyczna sprężyna", desc: "Ruch oparty na fizyce, który wygląda żywo" },
          { title: "Pierścień ładowania", desc: "Pierścień postępu kończący się satysfakcjonująco" },
          { title: "Wybuch cząsteczek", desc: "Mała eksplozja cząsteczek opartych na fizyce" },
          { title: "Odwrócenie karty", desc: "Karta, która się obraca i pokazuje drugą stronę" },
          { title: "Fala Ripple", desc: "Koncentryczne fale rozchodzące się na zewnątrz" },
          { title: "Puls poświaty", desc: "Miękka poświata rozchodząca się i zanikająca" },
          { title: "Shimmer", desc: "Pasmo światła przesuwające się po pasku ładowania" },
          { title: "Przeciągnij i wróć", desc: "Przeciągnij gdziekolwiek, wraca do środka" },
          { title: "Wybuch konfetti", desc: "Mały wybuch kolorowego konfetti" },
          { title: "Przełącznik", desc: "Płynne przesunięcie suwaka wł./wył." },
          { title: "Pasek postępu", desc: "Pasek wypełniający się w satysfakcjonujący sposób" },
          { title: "Nachylenie 3D", desc: "Karta pochylająca się z kursorem w prawdziwym 3D" },
          { title: "Migający kursor", desc: "Mała maszyna do pisania z migającym kursorem" },
          { title: "Puls polubienia", desc: "Serce, które wypełnia się i błyska po dotknięciu" },
          { title: "Ocena gwiazdkowa", desc: "Najedź, by zobaczyć podgląd, kliknij, by ustawić ocenę" },
          { title: "Loader szkieletowy", desc: "Migoczący placeholder, który zamienia się w treść" },
          { title: "Podkreślenie zakładki", desc: "Wskaźnik przesuwający się pod aktywną zakładką" },
          { title: "Suwak zakresu", desc: "Przeciągalny uchwyt z podglądem wartości na żywo" },
          { title: "Odznaka powiadomień", desc: "Licznik, który podskakuje przy każdym nowym powiadomieniu" },
          { title: "Potwierdzenie kopiowania", desc: "Ikona potwierdzająca kopiowanie znacznikiem" },
          { title: "Loader z kropkami", desc: "Trzy kropki podskakujące w nieskończonej pętli" },
        ],
      },
      logo: {
        title: "Projektowanie logo",
