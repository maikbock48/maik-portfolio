export const translations = {
  ...
  pl: {
    ...
    home: {
      ...
      name: "Maik Bock",
      description:
        "Buduję aplikacje full-stack, skalowalne API i systemy AI – szybko, precyzyjnie i nie do zignorowania. Stwórzmy coś wielkiego.",
    ...
    contact: {
      ...
      subtitle:
        "Jeśli poważnie myślisz o zbudowaniu czegoś wielkiego, odezwij się – działam szybko i oczekuję tego samego.",
      firstname: "Imię",
      lastname: "Nazwisko",
      email: "Adres e-mail",
