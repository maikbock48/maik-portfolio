export const translations = {
  en: {
    ...
    contact: {
      ...
      blockedClose: "Got it",
      blockedWhatsapp: "Chat on WhatsApp",
      blockedEmail: "Send an Email",
    },
    footer: {
  ...
  de: {
    ...
    contact: {
      ...
      blockedWhatsapp: "Auf WhatsApp chatten",
      blockedEmail: "E-Mail schreiben",
    },
    footer: {
    ...
    serviceDetails: {
      ...
      uiux: {
        ...
        showcase: [
          ...
          { title: "Liquid Morph", desc: "Formen, die atmen und fließen" },
          ...
          { title: "Ripple Wave", desc: "Konzentrische Wellen, die nach außen laufen" },
          { title: "Glow Pulse", desc: "Ein sanftes Leuchten, das nach außen atmet und verblasst" },
          { title: "Shimmer", desc: "Ein Lichtstreif, der über einen Ladebalken zieht" },
          { title: "Drag & Snap", desc: "Zieh ihn irgendwohin, er springt zur Mitte zurück" },
  ...
  pl: {
    ...
    contact: {
      ...
      blockedWhatsapp: "Napisz na WhatsApp",
      blockedEmail: "Wyślij e-mail",
    },
    footer: {
